...
class _LoginViewState extends State<LoginView>
    implements LoginPresenterContract {
                  ...
                  children: [
                    ...
                    Row(children: [
                      Expanded(
                        ...
                        child: _presenter.errorMessage == null
                            ? Container()
                            : Container(
                                padding:
                    ...
                    Container(
                      ...
                      child: BsInput(
                        ...
                        validators: [
                          UtilsValidation.inputRequired(LoginText.formUsername),
                    ...
                    Container(
                      ...
                      child: BsInput(
                        ...
                        obscureText: true,
                        validators: [
                          UtilsValidation.inputRequired(LoginText.formPassword),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: BsButton(
                        disabled: _presenter.isLoading,
                        label: Text(LoginText.buttonLogin),
                        size: BsButtonSize(
                            fontSize: 16.0,
                            padding:
                        ...
                        onPressed: () {
                          if (_formState.currentState!.validate() &&
                              !_presenter.isLoading) _presenter.login(context);
                        },
                      ),
                    ),
                    Container(
                      child: Text(
                        LoginText.footerCopyright,
                        style: TextStyle(
                            color: Color(0xff575962),
                            fontSize: 14.0,
